...
const recomandContainer = document.querySelector('.recomand-movies-area');
const recomandCarousel = recomandContainer.querySelector('.card-carousel');
...
(() => {
  fetch(url, options)
    ...
    .then((json) => {
      ...
      rederCarousel('infinity', top10, recomandList);
      btnUtils();
    })
    .catch(console.error);
})();
